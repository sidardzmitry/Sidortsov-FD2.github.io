window.onload = function () {
  ...
  function drawName() {
    ...
    ctx.font = "105px sunshiney";
    ctx.fillText("Christma’s Eve",canvas.width / 2 + 50,canvas.height / 2 + 223);
  };
